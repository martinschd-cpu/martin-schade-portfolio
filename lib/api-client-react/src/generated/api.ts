...
export const getSendContactMessageMutationOptions = <TError = ErrorType<ContactResponse>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendContactMessageMutationError = ErrorType<ContactResponse>

    /**
 * @summary Send a contact form message
 */
export const useSendContactMessage = <TError = ErrorType<ContactResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendContactMessage>>, TError,{data: BodyType<ContactRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
